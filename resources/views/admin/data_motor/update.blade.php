    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('update-data-motor') }}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <input type="hidden" name="id" id="id" value="{{ $motor->id }}">
                    <div>
                        ...
                        <x-text-input id="nama_sepeda_motor" class="block mt-1 w-full" type="text"
                            name="nama_sepeda_motor" value="{{ $motor->nama_sepeda_motor }}" required autofocus
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="harga" class="block mt-1 w-full" type="number" name="harga"
                            value="{{ $motor->harga }}" required autofocus autocomplete="harga" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="jarak" class="block mt-1 w-full" type="number" name="jarak"
                            value="{{ $motor->jarak }}" required autofocus autocomplete="jarak" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="tahun" class="block mt-1 w-full" type="number" name="tahun"
                            value="{{ $motor->tahun }}" required autofocus autocomplete="tahun" />
                        <x-input-error :messages="$errors->get('tahun')" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="spesifikasi" :value="__('Spesifikasi')" />
                        <textarea id="spesifikasi" name="spesifikasi" rows="6"
                            class="block mt-1 w-full p-2 border border-gray-300 rounded-md" required autofocus autocomplete="spesifikasi">{{ old('spesifikasi', $motor->spesifikasi) }}</textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="gambar" class="block mt-1 w-full" type="file" name="gambar" autofocus
                            autocomplete="gambar" />
