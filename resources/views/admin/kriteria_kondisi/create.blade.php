    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('kriteria-kondisi') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mt-4">
                        <x-input-label for="kondisi" :value="__('Kondisi Motor')" />
                        <x-text-input id="kondisi" class="block mt-1 w-full" type="text" name="kondisi"
                            :value="old('kondisi')" required autofocus autocomplete="kondisi" />
