    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('update-kriteria-harga') }}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="harga" class="block mt-1 w-full" type="text" name="harga"
                            value="{{ $harga->harga }}" required autofocus autocomplete="harga" />
                    ...
                    <div>
                        ...
                        <x-text-input id="keterangan" class="block mt-1 w-full" type="text" name="keterangan"
                            value="{{ $harga->keterangan }}" required autofocus autocomplete="keterangan" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="nilai" class="block mt-1 w-full" type="number" name="nilai"
                            value="{{ $harga->nilai }}" required autofocus autocomplete="nilai" />
